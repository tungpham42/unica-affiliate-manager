...
1. Upload the plugin files to the `/wp-content/plugins/unica-affiliate-manager` directory, or install the plugin through the WordPress plugins screen directly.
